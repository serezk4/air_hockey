package com.serezk4.security.auth.converter;

import com.serezk4.security.auth.model.CustomUserDetails;
import com.serezk4.security.auth.token.CustomJwtAuthenticationToken;
...
public class CustomJwtAuthenticationConverter implements Converter<Jwt, Mono<AbstractAuthenticationToken>> {
    ...
    /**
     * Extracts the roles from the JWT's {@code realm_access} claim and converts them into {@link GrantedAuthority} obj.
     *
