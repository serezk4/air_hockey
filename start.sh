...
start_service "Prometheus" "./service/prometheus" "prometheus" 40
start_service "Grafana" "./service/grafana/" "grafana" 40
start_service "RabbitMQ" "./service/rabbitmq" "rabbitmq" 40
